...
{
    public class @RPGInputsFREE : IInputActionCollection, IDisposable
    {
        public InputActionAsset asset { get; }
        public @RPGInputsFREE()
        {
    ...
    ""controlSchemes"": [
        ...
        {
            private @RPGInputsFREE m_Wrapper;
            public RPGCharacterActions(@RPGInputsFREE wrapper) { m_Wrapper = wrapper; }
